...
*/
    ...
    int y = 0;
    //定义一个变量记录路径（Windows）
    String path = "E:\\java\\Programming-novice\\JavaProject\\src\\上半.image\\animal\\animal3\\";
    //mac路径
    ...
    private void initImage() {
        ...
        if (victory()){
            //windows
            JLabel winJLabel = new JLabel(new ImageIcon("E:\\java\\Programming-novice\\JavaProject\\src\\上半.image\\win.png"));
            //mac
        ...
        //添加背景图片
        //Windows
        JLabel background = new JLabel(new ImageIcon("E:\\java\\Programming-novice\\JavaProject\\src\\上半.image\\background.png"));
        //mac
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (obj == replayItem){
            ...
            //创建一个管理图片的容器对象jlaval
            JLabel jLabel = new JLabel(new ImageIcon("E:\\java\\Programming-novice\\JavaProject\\src\\上半.image\\money.png"));
            //mac
          ...
          path = "E:\\java\\Programming-novice\\JavaProject\\src\\上半.image\\girl\\girl" + index +"\\";
          step = 0;
          initDate();
          initImage();
        }else if (obj == animal){
          int index = r.nextInt(8) + 1;
          path = "E:\\java\\Programming-novice\\JavaProject\\src\\上半.image\\animal\\animal" + index +"\\";
          step = 0;
          initDate();
          initImage();
        }else if (obj == sport){
          int index = r.nextInt(10) + 1;
          path = "E:\\java\\Programming-novice\\JavaProject\\src\\上半.image\\sport\\sport" + index +"\\";
          step = 0;
          initDate();
          initImage();
        }
